...
SYSTEM_OPTION_CPU_TILING_1 = "CPU modu zayif bilgisayarlarin daha hizli calismasini saglar."
SYSTEM_OPTION_CPU_TILING_2 = "Eger grafiklerde problem varsa diger secenegi isaretleyiniz ,Sistem secenekleri' veya ,CONFIG.exe'"
SYSTEM_OPTION_CPU_TILING_3 = "ve GPU modunu secin."
SYSTEM_OPTION_GPU_TILING_1 = "GPU Modu zayif bilgisayarlari daha yavas calistirir."
SYSTEM_OPTION_GPU_TILING_2 = "Grafik ile ilgili sorunlarda, 'Sistem Secenekleri' veya 'CONFIG.exe'yi sec"
SYSTEM_OPTION_GPU_TILING_3 = "GPU modunu degistirin."
SYSTEM_OPTION_TILING_EXIT = "Tiling-Modu degisimi icin oyun yeniden baslatilmali."
